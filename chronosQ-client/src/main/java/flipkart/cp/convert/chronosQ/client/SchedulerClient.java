...
public class SchedulerClient<Entry extends SchedulerEntry> {
    ...
    public void add(Entry schedulerEntry, long time) throws SchedulerException {
        ...
        try {
            store.add(new SchedulerData(val, schedulerEntry.getPayload()), timeBucket.toBucket(time), partitionNumber);
    ...
    public boolean update(Entry schedulerEntry, long oldTime, long newTime) throws SchedulerException {
        ...
        try {
            Long storeResult = store.update(new SchedulerData(val, schedulerEntry.getPayload()), timeBucket.toBucket(oldTime), timeBucket.toBucket(newTime), partitionNumber);
