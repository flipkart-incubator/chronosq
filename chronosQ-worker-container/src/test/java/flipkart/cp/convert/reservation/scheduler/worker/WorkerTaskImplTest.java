...
public class WorkerTaskImplTest {
    ...
    List<String> values = Arrays.asList("something");
    ...
    public void setUp() throws SchedulerException, InterruptedException {
        ...
        when(schedulerStore.get(longValue, partitionNum)).thenReturn(empty);
    ...
    public void processTest() throws Exception {
        ...
        verify(schedulerStore, atLeastOnce()).removeBulk(longValue, partitionNum, values);
